...
public enum Lang {
  ...
  public String getText(final String key, final String value) {
    return LangFile.getString(this, key, value);
  }

  public String getText(final Map<String, String> placeholders) {
  ...
  public List<String> getList(final String key, final String value) {
    return LangFile.getList(this, key, value);
  }

  public List<String> getList(final Map<String, String> placeholders) {
