...
public class GeneralGui extends Gui {
  ...
  private static UnaryOperator<Integer> slotFunc = i ->
    ((i > 16) && (i < 21)) ? 21 : ((i > 25) && (i < 30)) ? 30 : ((i > 34) && (i < 39)) ? 39 : i;

  private static ItemBuilder emptyBuilder = new ItemBuilder(Material.GLASS_PANE, true)
    .setName(" ")
    .remove(Properties.LORE);
  private static ItemBuilder infoBuilder = ItemBuilder
    .ofHead("MHF_Question", true)
    .setName(Lang.CREDITS.getText())
    .setLore(InfoCommand.infoList);
  private static ItemBuilder trophyBuilder = ItemBuilder
    .ofHeadUrl(Config.TROPHY_HEAD_URL.getText(), true)
    .setName(Lang.RANKING_NAME.getText())
  ...
  private ItemStack soulToItem(final UUID soul, final int amount) {
    ...
    return ItemBuilder
      ...
      .addLore(Lang.INVENTORY_SOUL_LORE.getList())
      .build();
  }
