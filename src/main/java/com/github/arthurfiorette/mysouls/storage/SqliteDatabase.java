...
public class SqliteDatabase implements Database<UUID, String> {
  ...
  public void save(final UUID key, final String value) {
    ...
    try (Connection connection = this.dataSource.getConnection();
      ...
      this.basePlugin.getExceptionHandler().handle(this.getClass(), exc,
      ...
      try {
        ...
        this.basePlugin.getExceptionHandler().handle(this.getClass(), e,
  ...
  public String get(final UUID key) {
    ...
    try (Connection connection = this.dataSource.getConnection();
      ...
      this.basePlugin.getExceptionHandler().handle(this.getClass(), ex,
